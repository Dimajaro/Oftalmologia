                            ...
                            <div class="row col-lg-4 col-12 col-sm-12 justify-content-center sinmargen sinpaddingderecho">
                                ...
                                <div class="row col-lg-4 col-12 col-sm-12 justify-content-center sinmargen sinpaddingderecho minpaddingizquierdo">
                                    ...
                                    <div class="row col-lg-12  col-12 col-sm-12 sinmargen sinpadding justify-content-center">
                                        ...
                                        <input id="toPioOD" class="form-control col-lg-12 col-8 col-sm-8 sinpadding " placeholder="OD" type="number" step="0.01">
                                        <input id="toPioOI" class="form-control col-lg-12 col-8 col-sm-8 sinpadding " placeholder="OI" type="number" step="0.01">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row col-lg-12 col-12 col-sm-12 justify-content-center">
                            <div class=" row col-lg-5 col-12  col-sm-12 sinmargen sinpadding" >
                                ...
                                <div class="col-lg-3 col-6 col-sm-6 sinmargen sinpadding">
                                    ...
                                    <input id="rlAvOD" class="form-control col-lg-12 sinpadding col-12 col-sm-12" placeholder="OD" type="number" step="0.01" >
                                    <input id="rlAvOI" class="form-control col-lg-12  sinpadding col-12 col-sm-12" placeholder="OI" type="number"  step="0.01">
                        ...
                        <div class="row col-lg-12 col-12 justify-content-center">
                            <div class="col-lg-4 col-12 sinmargen">
                                ...
                                <div id="boxDiv" class="col-lg-12 form-check col-12 inDiv" style=" height: 175px; overflow-y: scroll;">
                                    <label class="form-check-label col-lg-12 col-12">
                                        <input type="checkbox" class="form-check-input" value="">Adiciones iguales 
                                    </label>
                            ...
                            <div class=" row col-lg-3  col-12 align-self-center sinmargen">
                                <div class="form-check col-lg-12 col-6 inDiv">
                                    <label class="form-check-label col-12 col-lg-12">
                                        <input type="radio" class="form-check-input" name="optradio">Lentes Opticos
                                    </label>
                                </div>
                                <div class="form-check col-lg-12 col-6 inDiv">
                                    <label class="form-check-label col-12 col-lg-12">
                                        <input type="radio" class="form-check-input" name="optradio">Lentes de Contacto
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row col-lg-2 col-12 justify-content-end align-self-end">
                                <button class="btn btn-info col-lg-6 col-4">
