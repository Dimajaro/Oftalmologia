                        ...
                        <div class="row col-lg-12 col-12 col-sm-12 justify-content-center primeraFila fila">
                            ...
                            <div class="row col-lg-4 col-12 col-sm-12  sinmargen justify-content-center sinpadding">
                                ...
                                <div class="col-lg-4 col-6 col-sm-4 sinpadding sinmargen">
                                    ...
                                    <input id="reEsfOD" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OD" type="number"  step="0.25" >
                                    <input id="reEsfOI" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-4 col-6 col-sm-4 sinpadding sinmargen">
                                    <label class="col-lg-12 col-12 col-sm-12 subt">Cil</label>
                                    <input id="reCilOD" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OD" type="number" step="0.25" >
                                    <input id="reCilOI" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OI" type="number"  step="0.25">
                                </div>
                                ...
                                <div class="col-lg-12 col-12 col-sm-12 styleBtn sinpadding">
                                    <button class="btn btn-danger btn-md " onclick="limpiar('re')" >limpiar</button>
                                    <button class="btn btn-info btn-md " onclick="copiar('re', 'rl')">copiar a Receta Lejos</button>
                                </div>
                            </div>
                            ...
                            <div class="row col-lg-4 col-12 col-sm-12 justify-content-center sinmargen sinpaddingderecho">
                                <div class="row col-lg-8 col-12 col-sm-12 sinmargen sinpadding">
                                    ...
                                    <div class="col-lg-6 col-6 col-sm-6 sinpadding sinmargen">
                                        ...
                                        <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="avScOD" >
                                            ...
                                            <option value="11">0.0</option>
                                            <option value="12">Cuenta dedos</option>
                                            <option value="13">Cuenta manos</option>
                                            <option value="14">Percibe luz</option>
                                            <option value="15">Ceguera/amaurosis</option>
                                        </select>
                                        <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="avScOI" >
                                    ...
                                    <div class="col-lg-6 col-6 col-sm-6 sinpadding sinmargen">
                                        ...
                                        <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="avCcOD" >
                                            <option value="">OD</option>
                                            <option value="1">1</option>
                                            <option value="2">0.9</option>
                                            <option value="3">0.8</option>
                                        ...
                                        <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="avCcOI" >
                                            <option value="">OI</option>
                                            <option value="1">1</option>
                                            <option value="2">0.9</option>
                                            <option value="3">0.8</option>
...
<!--                                        <input id="avCilOD" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OD" type="number" step="0.01" >
 <input id="avCilOI" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OI" type="number"  step="0.01">-->
                                    ...
                                    <div class="col-lg-12 col-12 col-sm-12 justify-content-center styleBtn sinpadding">
                                        <button class="btn btn-danger btn-md " onclick="limpiar('av')">limpiar</button>
                                ...
                                <div class="row col-lg-4 col-12 col-sm-12 justify-content-center sinmargen sinpaddingderecho minpaddingizquierdo">
                                    ...
                                    <div class="col-lg-12 col-12 col-sm-12 justify-content-center styleBtn sinpadding">
                                        <button class="btn btn-danger btn-md " onclick="limpiar('to')">limpiar</button>
                            ...
                            <div class=" row col-lg-4 col-12 col-sm-12 justify-content-center sinmargen sinpaddingderecho">
                                ...
                                <div class="col-lg-4 col-6 col-sm-4 sinmargen sinpadding">
                                    <label class="col-lg-12 col-12 col-sm-12 subt">Esf</label>
                                    <input id="leEsfOD" class="form-control col-sm-12 col-lg-12 sinpadding col-12" placeholder="OD" type="number" step="0.25" >
                                    <input id="leEsfOI" class="form-control col-sm-12 col-lg-12  sinpadding col-12" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-4 col-6 col-sm-4 sinmargen sinpadding">
                                    <label class="col-lg-12 col-sm-12 col-12 subt">Cil</label>
                                    <input id="leCilOD" class="form-control col-lg-12 col-sm-12 sinpadding col-12" placeholder="OD" type="number" step="0.25" >
                                    <input id="leCilOI" class="form-control col-lg-12  col-sm-12 sinpadding col-12" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class=" row col-lg-4 col-8 col-sm-4 sinmargen sinpadding">
                                    ...
                                    <input id="leEjeOI" class="form-control col-lg-12 col-sm-12 sinpadding col-12" placeholder="OI" type="number"  step="0.01">
                                </div>
                                <div class="col-lg-12 col-12 col-sm-12 styleBtn sinpadding">
                                    <button class="btn btn-danger btn-md " onclick="limpiar('le')">limpiar</button>
                                    <button class="btn btn-info btn-md " onclick="copiar('le', 'rc')">copiar a Receta Cerca</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row col-lg-12 col-12 col-sm-12 justify-content-center segundaFila fila">
                            <div class=" row col-lg-4 col-12  col-sm-12 sinmargen sinpadding" >
                                ...
                                <div class="col-lg-3 col-6 col-sm-6 sinmargen sinpadding">
                                    ...
                                    <input id="rlEsfOD" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OD" type="number" step="0.25" >
                                    <input id="rlEsfOI" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-3 col-6 col-sm-6 sinmargen sinpadding">
                                    <label class="col-lg-12 col-12 col-sm-12 subt">Cil</label>
                                    <input id="rlCilOD" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OD" type="number" step="0.25" >
                                    <input id="rlCilOI" class="form-control col-lg-12 col-12 col-sm-12 sinpadding" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-3 col-6 col-sm-6 sinmargen sinpadding">
                                    <label class="col-lg-12 col-12 col-sm-12 subt">Eje</label>
                                    ...
                                    <label class="col-lg-12 subt col-2 col-sm-12 sinpaddingizquierdo sinmargeninferior">Distancia Pupilar</label>
                                </div>
                                <div class="col-lg-3 col-6 col-sm-6 sinmargen sinpadding">
                                ...
                                <div class="col-lg-12 col-12 col-sm-12 styleBtn sinpadding">
                                    <button class="btn btn-danger btn-md " onclick="limpiar('rl')">limpiar</button>
                                </div>
                            </div>
                            <div class="col-lg-2 col-12 col-sm-12 styleBtn sinpaddingderecho align-self-center justify-content-center">

                                <button class="col-12 btn btn-info btn-md " onclick="copiar('rl', 'rc')">copiar a Receta Cerca</button>
                            </div>

                            <div class="row col-lg-6 col-12 col-sm-12 sinmargen justify-content-center align-self-end sinpaddingderecho minpaddingizquierdo">
                                ...
                                <div class="col-lg-2 sinpadding col-6 col-sm-4 sinmargen">
                                    ...
                                    <label class="form-check-label col-lg-12 col-12 col-sm-12 sinpadding">
                                        <input id="rcAdIguales" type="checkbox" class="form-check-input " value="" onchange="adIgual()">Adiciones iguales 
                                    </label>
                                </div>
                                <div class="col-lg-2 sinpadding col-6 col-sm-4 sinmargen">
                                    <label class="col-lg-12 col-12 subt col-sm-12">Esf</label>
                                    <input id="rcEsfOD" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OD" type="number" step="0.25" >
                                    <input id="rcEsfOI" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-2 sinpadding col-8 col-sm-4 sinmargen">
                                    <label class="col-lg-12 subt col-12 col-sm-12">Cil</label>
                                    <input id="rcCilOD" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OD" type="number" step="0.25" >
                                    <input id="rcCilOI" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OI" type="number"  step="0.25">
                                </div>
                                <div class="col-lg-2 sinpadding col-6 col-sm-6 sinmargen">
                                    ...
                                    <label class="col-lg-12 subt col-12 col-sm-12 sinpaddingizquierdo sinmargeninferior">Distancia Pupilar</label>
                                </div>
                                <div class="col-lg-2 sinpadding col-6 col-sm-6 sinmargen">
                                    <label class="col-lg-12 sinpadding subt col-12">J</label>
                                    <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="rcJOD" >
                                        <option value="">OI</option>
                                    ...
                                    <select class="form-control col-lg-12 col-12 col-sm-12 sinpadding" id="rcJOI" >
                                        <option value="">OI</option>
                                        <option value="1">J</option>
                                        <option value="2">J1</option>
                                        <option value="3">J2</option>
...
<!--                                    <input id="rcJOD" class="form-control col-lg-12 col-12 sinpadding" placeholder="OD" type="number" step="0.01" >
                                ...
                                <div class="col-lg-12 col-12 col-sm-12 styleBtn sinpadding">
                                    <button class="btn btn-danger btn-md " onclick="limpiar('rc')">limpiar</button>
                                </div>
                            </div>

                        </div>
                        <!--tercera fila de datos-->
                        <div class="row col-lg-12 col-12 col-sm-12 justify-content-left fila">
                            <div class="col-lg-2 sinpadding col-12 col-sm-8 sinmargen">
                                <label class="col-lg-12 col-12 titulo col-sm-12">Vertex</label>
                                <input id="vtxOD" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OD" type="number" min="0" max="50" step="1" onchange="validarVtx()">
                                <input id="vtxOI" class="form-control col-lg-12 col-12 sinpadding col-sm-12" placeholder="OI" type="number" min="0" max="50" step="1" onchange="validarVtx()">
                            </div>
                        </div>

                        <!--cuarta fila de datos-->
                        <div class="row col-lg-12 col-12 justify-content-center fila">
                            ...
                            <div class=" row col-lg-3  col-12 align-self-center sinmargen">
                                <div class="form-check col-lg-12 col-6 inDiv">
                                    <label class="form-check-label col-12 col-lg-12" >
                                        <input id="chkOptico" type="checkbox" class="form-check-input" onchange="mostraCheckbox()" >Lentes Opticos
                                    </label>
                                </div>
                                <div class="form-check col-lg-12 col-6 inDiv">
                                    <label class="form-check-label col-12 col-lg-12" >
                                        <input id="chkContacto" type="checkbox" class="form-check-input" onchange="mostraCheckbox()" >Lentes de Contacto
                                    </label>
                                </div>
                            </div>
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button class="btn btn-info" onclick="impReceta()">
    ...
    <script type="text/javascript">
        ...
        function guardarReceta()
        {
            ...
            alert("" + refraccionEsfOD + refraccionEsfOI + refraccionCilOD + refraccionCilOI + refraccionEjeOD + refraccionEjeOI
                    ...
                    + recetacercaJOD + recetacercaJOI + recetacercaDisPup + vertexOD + vertexOI + opticoOrganico + opticoVidrio + opticoPoli
                    ...
                    + contactoProlon + contactoMultifo + chkOptico + chkContacto + recetaLejos + recetaCerca
                    );
        }
        ...
        $(document).ready(function () {
            $('.ajustar').on('change', function ()
            {
                if (this.value == 0.01)
                    this.setAttribute('step', '0.24');

                else
                    this.setAttribute('step', '0.25');
            })
        });
        ...
        function sendajaxguardaratencion(hora, nombre, id, estado) {
